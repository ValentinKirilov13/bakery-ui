...
export default function ProductDetails() {
    ...
    const product = useFetch(`http://localhost:3030/jsonstore/products/${productId}`, {});
                ...
                <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pr-8 lg:pb-16">
                    ...
                    <div className="flex gap-20">
                        ...
                        <div className="mt-10 border-l border-gray-300 pl-6">
                            <h3 className="text-sm font-medium text-gray-900">Allergens</h3>

                            <div className="mt-4">
                                <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                                    {product.allergens?.map((allergen) => (
                                        <li key={allergen} className="text-gray-400">
